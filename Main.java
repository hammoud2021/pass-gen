  ...
  public static void main(String[] args) throws IOException {
    ...
    for (int playsRemaining = 5; playsRemaining > 0; playsRemaining--) 
    {
      ...
      if (selection == 1) {
        ...
        // generate uppercase password file
      ...
      if (selection == 3) {
        ...
        // generate mixed case password file
        File ffileName3 = new File("Mixedpw.txt");
        PrintWriter foutFile3 = new PrintWriter(ffileName3);
        int perLine3 = 0;
        for (int i = 0; i < mixed.length; i++) {
          foutFile3.print(mixed[i]);// going to make 125 passwords, 8 per line
          perLine3++;
          if (perLine3 == 8) {
            foutFile3.println();
            perLine3 = 0;
      ...
      if (selection == 4) {
        ...
        // generate mixed with numbers password file
      ...
      if (selection == 5) 
      {
        ...
        // generate any character (excluding space) password file
